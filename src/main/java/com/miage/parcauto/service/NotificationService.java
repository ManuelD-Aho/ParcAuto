...
public interface NotificationService {
     ...
     * @throws UtilisateurNotFoundException Si l'utilisateur destinataire n'existe pas.
     * @throws OperationFailedException Si une erreur technique survient.
     */
    void createNotification(NotificationDTO notificationDTO) throws ValidationException, UtilisateurNotFoundException, OperationFailedException;
     ...
     * @throws OperationFailedException Si une erreur technique survient.
     */
    List<NotificationDTO> getNotificationsNonLues(Integer idUtilisateur) throws UtilisateurNotFoundException, OperationFailedException;

    /**
     * Récupère toutes les notifications (lues et non lues) pour un utilisateur spécifique.
     *
     * @param idUtilisateur L'identifiant de l'utilisateur.
     ...
     * @throws OperationFailedException Si une erreur technique survient.
     */
    List<NotificationDTO> getAllNotificationsForUtilisateur(Integer idUtilisateur) throws UtilisateurNotFoundException, OperationFailedException;
     ...
     *
     * @param idsNotification Liste des identifiants de notifications à marquer comme lues.
     * @param idUtilisateur L'identifiant de l'utilisateur propriétaire des notifications.
     * @throws OperationFailedException Si une erreur technique survient.
     */
    void marquerNotificationsCommeLues(List<Integer> idsNotification, Integer idUtilisateur) throws OperationFailedException;
