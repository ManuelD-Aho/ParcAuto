...
public interface EntretienService {
     ...
     * @throws ValidationException       Si les données de l'entretien sont
     *                                   invalides.
    ...
    EntretienDTO createEntretien(EntretienDTO entretienDTO)
            throws ValidationException, VehiculeNotFoundException, OperationFailedException;
     ...
     * @throws OperationFailedException  Si une erreur technique survient.
     */
    List<EntretienDTO> getEntretiensByVehiculeId(Integer idVehicule)
     ...
     * @throws ValidationException        Si les données de l'entretien sont
     *                                    invalides.
     * @throws EntretienNotFoundException Si l'entretien à mettre à jour n'est pas
     *                                    trouvé.
     * @throws VehiculeNotFoundException  Si le véhicule associé (s'il est modifié)
     *                                    n'existe pas.
     * @throws OperationFailedException   Si une erreur technique survient.
     */
    EntretienDTO updateEntretien(EntretienDTO entretienDTO)
            throws ValidationException, EntretienNotFoundException, VehiculeNotFoundException, OperationFailedException;

    /**
     * Supprime un entretien par son identifiant.
     *
     * @param idEntretien L'identifiant de l'entretien à supprimer.
     * @throws EntretienNotFoundException Si l'entretien à supprimer n'est pas
     *                                    trouvé.
     * @throws OperationFailedException   Si une erreur technique survient.
     */
     ...
     * @param kmVehicule          Le kilométrage du véhicule au moment de la fin de
     *                            l'entretien.
     * @param kmProchainEntretien Le kilométrage prévu pour le prochain entretien
     *                            (si applicable).
     ...
     * @throws OperationFailedException   Si une erreur technique survient.
     */
    EntretienDTO terminerEntretien(Integer idEntretien, LocalDateTime dateRealisation, BigDecimal coutReel,
            Integer kmVehicule, Integer kmProchainEntretien, String observations)
            throws EntretienNotFoundException, ValidationException, OperationFailedException;

    /**
     * Récupère les entretiens planifiés (ou dont la date prévue est) dans un
     * intervalle de dates.
     *
     ...
     * @throws OperationFailedException Si une erreur technique survient.
     */
    List<EntretienDTO> getEntretiensPlanifiesEntre(LocalDateTime dateDebut, LocalDateTime dateFin)
