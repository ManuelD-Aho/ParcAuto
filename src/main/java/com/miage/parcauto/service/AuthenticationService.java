...
public interface AuthenticationService {
     ...
     * @throws AuthenticationException Si les identifiants sont incorrects ou l'utilisateur inactif.
     * @throws OperationFailedException Si une erreur technique survient durant le processus.
     */
    Optional<UtilisateurDTO> authenticate(String login, String motDePasse) throws AuthenticationException, OperationFailedException;
