...
public interface ReportingService {
     ...
     * Les données sont récupérées via d'autres services (VehiculeService, EntretienService, MissionService).
     *
     ...
     * @throws OperationFailedException Si une erreur technique survient lors de la collecte des données.
     */
    RapportVehiculeDTO genererRapportVehicule(Integer idVehicule) throws VehiculeNotFoundException, OperationFailedException;
    ...
    /**
     * Exporte un rapport (préalablement généré et stocké dans un RapportDTO) au format PDF.
     *
     ...
     * @throws ReportGenerationException Si une erreur survient lors de la génération du PDF.
     */
    byte[] exporterRapportPDF(RapportDTO rapportDTO) throws ReportGenerationException;

    /**
     * Exporte un rapport (préalablement généré et stocké dans un RapportDTO) au format Excel.
     *
     * @param rapportDTO Le DTO contenant les données du rapport à exporter.
     * @return Un tableau d'octets représentant le fichier Excel.
     * @throws ReportGenerationException Si une erreur survient lors de la génération du fichier Excel.
     */
