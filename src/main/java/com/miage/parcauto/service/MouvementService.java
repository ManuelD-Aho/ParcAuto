...
/**
 * Service pour la gestion des mouvements financiers sur les comptes
 * sociétaires.
 */
public interface MouvementService {
     ...
     * @throws ValidationException         Si les données du mouvement sont
     *                                     invalides.
     * @throws SocietaireNotFoundException Si le compte sociétaire associé n'existe
     *                                     pas.
     * @throws OperationFailedException    Si une erreur technique survient ou si le
     *                                     solde devient insuffisant pour un
     *                                     retrait.
     */
     ...
     * @throws OperationFailedException    Si une erreur technique survient.
     */
    List<MouvementDTO> getMouvementsByCompteSocietaireId(Integer idCompteSocietaire)
     ...
     * @throws OperationFailedException Si une erreur technique survient.
     */
    List<MouvementDTO> getMouvementsByDateRange(LocalDateTime dateDebut, LocalDateTime dateFin)
    ...
    // avec une logique métier appropriée (par exemple, suppression uniquement si
