...
public interface MissionService {
     ...
     * @throws VehiculeNotFoundException Si le véhicule associé n'existe pas ou n'est pas disponible.
     ...
     */
    MissionDTO createMission(MissionDTO missionDTO) throws ValidationException, VehiculeNotFoundException, UtilisateurNotFoundException, OperationFailedException;
     ...
     * @throws OperationFailedException Si une erreur technique survient.
     */
    List<MissionDTO> getMissionsByVehiculeId(Integer idVehicule) throws VehiculeNotFoundException, OperationFailedException;
     ...
     * @throws OperationFailedException Si une erreur technique survient.
     */
    List<MissionDTO> getMissionsByPersonnelId(Integer idPersonnel) throws UtilisateurNotFoundException, OperationFailedException;
     ...
     * @throws ValidationException Si les données de la mission sont invalides.
     * @throws MissionNotFoundException Si la mission à mettre à jour n'est pas trouvée.
     * @throws VehiculeNotFoundException Si le véhicule associé (s'il est modifié) n'existe pas ou n'est pas disponible.
     * @throws UtilisateurNotFoundException Si le personnel associé (s'il est modifié) n'existe pas.
     * @throws OperationFailedException Si une erreur technique survient.
     */
    MissionDTO updateMission(MissionDTO missionDTO) throws ValidationException, MissionNotFoundException, VehiculeNotFoundException, UtilisateurNotFoundException, OperationFailedException;

    /**
     * Supprime une mission par son identifiant.
     * Les dépenses associées peuvent également être supprimées ou gérées selon la logique métier.
     *
     ...
     * @throws OperationFailedException Si une erreur technique survient (ex: mission non clôturée).
     */
    void deleteMission(Integer idMission) throws MissionNotFoundException, OperationFailedException;

    /**
     * Termine une mission, mettant à jour son statut, le kilométrage du véhicule, etc.
     *
     ...
     * @throws ValidationException Si les données de clôture sont invalides (ex: kmRetour < kmDepart).
     * @throws OperationFailedException Si une erreur technique survient.
     */
    MissionDTO terminerMission(Integer idMission, int kmRetour, LocalDateTime dateFinEffective, String observations) throws MissionNotFoundException, ValidationException, OperationFailedException;
     ...
     * @throws OperationFailedException Si une erreur technique survient.
     */
    DepenseMissionDTO ajouterDepenseAMission(Integer idMission, DepenseMissionDTO depenseDTO) throws MissionNotFoundException, ValidationException, OperationFailedException;
     ...
     * @throws OperationFailedException Si une erreur technique survient.
     */
    List<DepenseMissionDTO> getDepensesByMissionId(Integer idMission) throws MissionNotFoundException, OperationFailedException;
     ...
     * @throws OperationFailedException Si une erreur technique survient.
     */
    List<MissionDTO> getMissionsActivesPourVehicule(Integer idVehicule) throws VehiculeNotFoundException, OperationFailedException;

    /**
     * Récupère les missions dont la date de début ou de fin se situe dans un intervalle donné.
     *
     ...
     * @throws OperationFailedException si une erreur d'accès à la base de données se produit.
     */
    List<MissionDTO> getMissionsParPeriode(LocalDateTime dateDebut, LocalDateTime dateFin) throws OperationFailedException;
}